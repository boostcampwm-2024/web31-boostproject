import{j as r}from"./jsx-runtime-DR9Q75dM.js";import{r as b}from"./index-DRjF_FHU.js";import{g as k}from"./useWorkspaceStore-B_R62rvF.js";import{_ as C}from"./index-D1AAVYfs.js";const T=`
...
`);let a=!1;return m.map(t=>i&&t.includes(`.${i}`)?(a=!0,`<span style="background-color: #FFF3AD;">${t}</span>`):a&&!t.includes("}")?`<span style="background-color: #FFF3AD;">${t}</span>`:a&&t.includes("}")?(a=!1,`<span style="background-color: #FFF3AD;">${t}</span>`):t.replace(/([^\s{}]+)\s*{/g,(u,c)=>{const n=i&&c.includes(`.${i}`)?`<span>${c}</span>`:c;return`<span class="${s.selector}">${n}</span> {`}).replace(/([\w-]+):/g,(u,c)=>`&nbsp;&nbsp;<span class="${s.property}">${c}</span>:`).replace(/:\s*([^;]+);/g,(u,c)=>`: <span class="${s["property-value"]}">${c}</span>;`)).join(`
`).split(`
`).map(t=>`  ${t}`).join(`
`)},B=(o,s,i)=>{const a=new DOMParser().parseFromString(o,"text/html"),e=(n,l)=>{const p="  ".repeat(l),d=`<span class="${s.tag}">${n.tagName.toLowerCase()}</span>`,g=Array.from(n.attributes).map(_=>{const N=_.name==="class"&&i&&_.value.includes(i)?_.value.replace(i,`<span style="background-color: #FFF3AD; color: green">${i}</span>`):_.value;return`<span class="${s.attribute}">${_.name}</span>=<span class="${s.value}">"${N}"</span>`}).join(" "),$=`${p}&lt;${d}${g?" "+g:""}&gt;`,y=`${p}&lt;/${d}&gt;`,f=Array.from(n.childNodes).map(_=>u(_,l+1)).join("");return["br","hr"].includes(n.tagName.toLowerCase())?`
${p}&lt;${d}${g?" "+g:""} /&gt;`:n.tagName.toLowerCase()==="head"?`${p}&lt;${d}${g?" "+g:""}&gt;${f.trim()}&lt;/${d}&gt;`:f.trim()?`
${$}
${f}
${y}`:`
${$}
${y}`},t=(n,l)=>{var g;const p=(g=n.textContent)==null?void 0:g.trim(),d="  ".repeat(l);return p?`
...
`).map(n=>`  ${n}`).join(`
`)},v=({code:o,codeLineList:s,selectedBlockStartLine:i,selectedBlockLength:m,selectedBlockType:a})=>{const[e,t]=b.useState([]),[u,c]=b.useState([]);return b.useEffect(()=>{const n=[];s.forEach((p,d)=>{(!e[d]||e[d]!==p)&&n.push(d)}),c(n);const l=setTimeout(()=>c([]),1e3);return t(s),()=>clearTimeout(l)},[o]),r.jsx("div",{className:h.codeContent,children:r.jsx("pre",{children:r.jsx("code",{children:s.map((n,l)=>{const p=i&&m&&l+1>=i&&l+1<i+m,d=a&&n.includes(a);return r.jsx("div",{className:`${u.includes(l)?h.newLine:""} ${p?h.blockHighlight:""} ${d?h.highlightBg:""}`,dangerouslySetInnerHTML:{__html:n}},l)})})})})};v.__docgenInfo={description:"",methods:[],displayName:"CodeContent",props:{code:{required:!0,tsType:{name:"string"},description:""},codeLineList:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},selectedBlockStartLine:{required:!1,tsType:{name:"number"},description:""},selectedBlockLength:{required:!1,tsType:{name:"number"},description:""},selectedBlockType:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:""}}};const x=({codeLineList:o})=>{const[s,i]=b.useState(null),m=e=>{i(e)},a=()=>{i(null)};return r.jsx("div",{className:h.lineNumbers,children:o.map((e,t)=>r.jsx("div",{onMouseEnter:()=>m(t+1),onMouseLeave:a,className:`${h.lineNumber} ${s===t+1?h.lineHighlight:""}`,children:t+1},t))})};x.__docgenInfo={description:"",methods:[],displayName:"LineNumbers",props:{codeLineList:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""}}};const w=({code:o,type:s,theme:i,selectedBlockStartLine:m,selectedBlockLength:a,selectedBlockType:e})=>{const u=(s==="html"?B(o,h,e):z(o,h,e)).split(`
`).filter(c=>c.trim()!=="");return r.jsxs("div",{className:`${h.viewer} ${i==="dark"?h.dark:h.light}`,children:[r.jsx(x,{codeLineList:u}),r.jsx(v,{code:o,codeLineList:u,selectedBlockLength:a,selectedBlockStartLine:m,selectedBlockType:e})]})};w.__docgenInfo={description:"",methods:[],displayName:"CodeViewer",props:{code:{required:!0,tsType:{name:"string"},description:""},type:{required:!0,tsType:{name:"union",raw:"'html' | 'css'",elements:[{name:"literal",value:"'html'"},{name:"literal",value:"'css'"}]},description:""},theme:{required:!1,tsType:{name:"union",raw:"'light' | 'dark'",elements:[{name:"literal",value:"'light'"},{name:"literal",value:"'dark'"}]},description:""},selectedBlockStartLine:{required:!1,tsType:{name:"number"},description:""},selectedBlockLength:{required:!1,tsType:{name:"number"},description:""},selectedBlockType:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:""}}};const G=({htmlCode:o,cssCode:s,selectedBlockStartLine:i,selectedBlockLength:m,selectedBlockType:a})=>{const[e,t]=b.useState("preview"),{isResetCssChecked:u}=k(),c=`
  ...
  `,l=`<style> * { box-sizing : border-box; margin : 0; padding : 0; } html, head, body { width : 100%; height : 100%; } ${u?`${T}
${s}`:s}</style>`,p=o.indexOf("</head>"),d=`${o.slice(0,p)}${c}${l}${o.slice(p)}`,g=async(y,f)=>{try{await navigator.clipboard.writeText(y),C.success(`${f} 코드가 복사되었습니다.`)}catch{C.error(`${f} 코드 복사에 실패했습니다.`)}},$=()=>{const y=e==="html"?o:s,f=e.toUpperCase();g(y,f)};return r.jsxs("section",{className:"flex-1 border-b border-gray-100",children:[r.jsxs("nav",{className:"flex h-10 border-b border-gray-100",children:[r.jsx("button",{onClick:()=>t("preview"),className:`${e==="preview"?"bg-green-500 text-white":"bg-white text-gray-200"} h-full flex-1 border-r border-gray-100 bg-green-500`,children:"미리보기"}),r.jsx("button",{onClick:()=>t("html"),className:`${e==="html"?"bg-green-500 text-white":"bg-white text-gray-200"} h-full flex-1 border-r border-gray-100 bg-green-500`,children:"HTML"}),r.jsx("button",{onClick:()=>t("css"),className:`${e==="css"?"bg-green-500 text-white":"bg-white text-gray-200"} h-full flex-1 bg-green-500`,children:"CSS"})]}),r.jsxs("div",{className:"relative h-full max-h-[calc(100%-26rem)] min-h-[20rem] w-full",children:[(e==="html"||e==="css")&&r.jsx("div",{className:"absolute right-4 top-5 z-50",children:r.jsx(L,{className:"h-6 w-6 cursor-pointer text-gray-300 hover:text-green-500",onClick:$})}),e==="preview"&&r.jsx("iframe",{srcDoc:d,className:"h-full w-full",title:"Preview",sandbox:"allow-same-origin"}),e==="html"&&r.jsx(w,{code:o,type:"html",theme:"light",selectedBlockStartLine:i,selectedBlockLength:m,selectedBlockType:a}),e==="css"&&r.jsx(w,{code:s,type:"css",theme:"light",selectedBlockType:a}),e==="css"&&r.jsx(w,{code:s,type:"css",theme:"light"})]})]})};G.__docgenInfo={description:`@description
