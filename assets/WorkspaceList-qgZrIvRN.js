import{j as r}from"./jsx-runtime-DR9Q75dM.js";import"./GuideVideo-MGmf4GR2.js";import{a as s}from"./HoveredEmptyWorkspace-BtO4R1QS.js";import"./WorkspaceLoadError-FmbY_INt.js";import"./NotHoveredEmptyWorkspace-CddEnm-X.js";import"./index-BXCeiWJk.js";import"./CssCategoryButton-cnkcY8L4.js";import"./client-Dbo3a7kb.js";import{u as i}from"./index-x70cJmE6.js";const a=({workspaceList:t})=>{const n=i();return r.jsx("ul",{className:"grid-cols-list grid w-[1128px] justify-start gap-x-6 gap-y-8",children:t.map(e=>r.jsx(s,{workspaceId:e.workspace_id,title:e.name,thumbnail:e.thumbnail||"",lastEdited:e.updated_at,onClick:()=>{n(`/workspace/${e.workspace_id}`)}},e.workspace_id))})};a.__docgenInfo={description:`@description
