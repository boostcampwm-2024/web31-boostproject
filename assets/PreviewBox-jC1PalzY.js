import{j as n}from"./jsx-runtime-DR9Q75dM.js";import{r as h}from"./index-DRjF_FHU.js";import{h as j,j as L}from"./html2canvas.esm-T2p3Seyt.js";import{u as N}from"./useCoachMarkStore-CAqI6O7S.js";import{_ as x}from"./index-D1AAVYfs.js";const S="_viewer_5mpew_1",q="_scrollContainer_5mpew_7",H="_dark_5mpew_13",E="_lineNumbers_5mpew_18",M="_lineNumber_5mpew_18",F="_lineHighlight_5mpew_28",I="_codeContent_5mpew_32",A="_tag_5mpew_37",R="_attribute_5mpew_41",D="_value_5mpew_45",V="_selector_5mpew_49",P="_property_5mpew_53",O="_newLine_5mpew_70",z="_fadeIn_5mpew_1",B="_blockHighlight_5mpew_74",m={viewer:S,scrollContainer:q,dark:H,lineNumbers:E,lineNumber:M,lineHighlight:F,codeContent:I,tag:A,attribute:R,value:D,selector:V,property:P,"property-value":"_property-value_5mpew_57",newLine:O,fadeIn:z,blockHighlight:B},k=({code:i,codeLineList:s,selectedBlockStartLine:o,selectedBlockLength:g,selectedBlockType:l})=>{const[t,r]=h.useState([]),[u,c]=h.useState([]);return h.useEffect(()=>{const e=[];s.forEach((d,p)=>{(!t[p]||t[p]!==d)&&e.push(p)}),c(e);const a=setTimeout(()=>c([]),1e3);return r(s),()=>clearTimeout(a)},[i]),n.jsx("div",{className:m.codeContent,children:n.jsx("pre",{children:n.jsx("code",{children:s.map((e,a)=>{const d=o&&g&&a+1>=o&&a+1<o+g,p=l&&e.includes(l);return n.jsx("div",{className:`${u.includes(a)?m.newLine:""} ${d?m.blockHighlight:""} ${p?m.highlightBg:""}`,dangerouslySetInnerHTML:{__html:e}},a)})})})})};k.__docgenInfo={description:"",methods:[],displayName:"CodeContent",props:{code:{required:!0,tsType:{name:"string"},description:""},codeLineList:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},selectedBlockStartLine:{required:!1,tsType:{name:"number"},description:""},selectedBlockLength:{required:!1,tsType:{name:"number"},description:""},selectedBlockType:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:""}}};const T=({codeLineList:i})=>{const[s,o]=h.useState(null),g=t=>{o(t)},l=()=>{o(null)};return n.jsx("div",{className:m.lineNumbers,children:i.map((t,r)=>n.jsx("div",{onMouseEnter:()=>g(r+1),onMouseLeave:l,className:`${m.lineNumber} ${s===r+1?m.lineHighlight:""}`,children:r+1},r))})};T.__docgenInfo={description:"",methods:[],displayName:"LineNumbers",props:{codeLineList:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""}}};const G=(i,s,o)=>{const g=i.split(`
`);let l=!1;return g.map(r=>o&&r.includes(`.${o}`)?(l=!0,`<span style="background-color: #FFF3AD;">${r}</span>`):l&&!r.includes("}")?`<span style="background-color: #FFF3AD;">${r}</span>`:l&&r.includes("}")?(l=!1,`<span style="background-color: #FFF3AD;">${r}</span>`):r.replace(/([^\s{}]+)\s*{/g,(u,c)=>{const e=o&&c.includes(`.${o}`)?`<span>${c}</span>`:c;return`<span class="${s.selector}">${e}</span> {`}).replace(/([\w-]+):/g,(u,c)=>`&nbsp;&nbsp;<span class="${s.property}">${c}</span>:`).replace(/:\s*([^;]+);/g,(u,c)=>`: <span class="${s["property-value"]}">${c}</span>;`)).join(`
`).split(`
`).map(r=>`  ${r}`).join(`
`)},K=(i,s,o)=>{const l=new DOMParser().parseFromString(i,"text/html"),t=(e,a)=>{const d="  ".repeat(a),p=`<span class="${s.tag}">${e.tagName.toLowerCase()}</span>`,b=Array.from(e.attributes).map(f=>{const y=f.name==="class"&&o&&f.value.includes(o)?f.value.replace(o,`<span style="background-color: #FFF3AD; color: green">${o}</span>`):f.value;return`<span class="${s.attribute}">${f.name}</span>=<span class="${s.value}">"${y}"</span>`}).join(" "),w=`${d}&lt;${p}${b?" "+b:""}&gt;`,C=`${d}&lt;/${p}&gt;`,_=Array.from(e.childNodes).map(f=>u(f,a+1)).join("");return["br","hr","img"].includes(e.tagName.toLowerCase())?`
...
`,W=({htmlCode:i,cssCode:s,selectedBlockStartLine:o,selectedBlockLength:g,selectedBlockType:l})=>{const[t,r]=h.useState("preview"),{isResetCssChecked:u}=j(),{currentStep:c}=N(),{setIframeRef:e}=L(),a=h.useRef(null),d=`
